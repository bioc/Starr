...
<<Plotting ChIP-enriched regions, echo=TRUE, eval=FALSE, results=hide>>=
plot(chers[[11]], rpb3_ratio_smooth, probeAnno=probeAnnoChr1, gff=transcriptAnno, paletteName="Spectral")
@

<<Plotting ChIP-enriched regions,eval=TRUE,results=hide,echo=FALSE>>=
png("cher.png", height=400, width=720)
plot(chers[[11]], rpb3_ratio_smooth, probeAnno=probeAnnoChr1, gff=transcriptAnno, paletteName="Spectral")
dev.off()
@
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=15cm]{cher.png}
